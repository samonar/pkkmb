                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <table class="table table-bordered table-striped" id="example1">
                            ...
                            <?php
                            $i=0;
                            foreach ($list_kelengkapan as $key) {
                                ?>
                                <tr>
                                    <td style="text-align: center"> <?php echo ++$i ?> </td>
                                    <td style="text-align: center"> <?php echo $key->nama_atribut ?> </td>
                                    <td style="text-align: center"> <?php echo $key->poin ?> </td>
                                    <td style="text-align: center"><?php echo ucfirst($key->waktu)  ?></td>
                                    <td style="text-align: center">
                                        <a href="<?php echo base_url('penilaian_kelengkapan/update/'.$key->id_kelengkapan.'/'.$key->id_camaba)?>">
                                            <span class="text-primary" style="font-size:21px">
                                                    <i class="fas fa-pencil-alt"></i>
                                            </span>
                                        </a> | 
                                        <a href="<?php echo base_url('penilaian_kelengkapan/delete/'.$key->id_kelengkapan.'/'.$key->id_camaba)?>">
                                            <span class="text-primary" style="font-size:21px">
