<form action="<?php echo base_url('user/update')?>" method="post" class="col-md-6 offset-md-3">
    <div class="form-group row">
        <label class="col-md-4 ">Nama user </label>
        <div class="col-md-7">
            <input type="text" name="nama" id="nama" class="form-control" placeholder="" value="<?php echo $data->nama_panitia ?>" required >
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <select  name="jabatan" id="jk" class="form-control" placeholder="" required>
                <?php if ($data->jabatan_panitia=="pendamping") { ?>
                    <option selected value="<?php echo $data->jabatan_panitia ?>"><?php echo $data->jabatan_panitia ?></option>
                <?php } else { ?>
                    <option value="<?php echo $data->jabatan_panitia ?>"><?php echo $data->jabatan_panitia ?></option>
                <?php }
                 ?>
