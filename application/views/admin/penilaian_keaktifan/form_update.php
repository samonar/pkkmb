        ...
        <div class="col-md-9">
            <div class="card ">
                <div class="card-header">
                    <h5 class="card-title">Edit Keaktifan</h5>
                </div>
                <div class="card-body">
            ...
            <form action="<?php echo base_url($action).'/'.$dataKeaktifan->id_penilaian_keaktifan.'/'.$id_camaba?>" method="post" class="offset-md-1">
                <div class="form-group row">
                    <label class="col-md-4 ">Jenis Keaktifan </label>
                    <div class="col-md-7">
                        <select name="id_kategori_keaktifan" id="" class="form-control">
                            <?php
                                foreach ($listKeaktifan as $key ) { ?>
                                    <option <?php if ($dataKeaktifan->id_kategori_keaktifan==$key->id_kategori_keaktifan) {
                                       echo  "selected";
                                    } ?> value="<?php echo $key->id_kategori_keaktifan ?>"> 
                                    <?php echo $key->jenis_keaktifan ?> </option>
                                <?php }
                            ?>
                        </select>
                    </div>
                ...
                <label class="col-md-4 ">Waktu</label>
                    <div class="col-md-7">
                        <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                            <input type="text" name="datetime" class="form-control datetimepicker-input" value="<?php echo date("m/d/Y h:i A", strtotime($dataKeaktifan->waktu)) ?>" data-target="#datetimepicker1"/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="number" name="poin" id="no_hp" class="form-control" value=<?php echo $dataKeaktifan->poin   ?>  disabled>
                    </div>
                </div>
                    <button type="cancel" class="btn btn-default ">
                        <a href="<?php echo base_url("penilaian_keaktifan/detail_penilaianKeaktifan/".$id_camaba)?>">Cancel</a>
                    </button>
