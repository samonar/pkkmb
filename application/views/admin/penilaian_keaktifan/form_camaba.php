                        ...
                        <table class="table table-bordered table-striped" id="example1">
                            ...
                            foreach ($list_keaktifan as $key) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center"> <?php echo $key->jenis_keaktifan ?> </td>
                                    <td style="text-align: center"> <?php echo $key->poin ?> </td>
                                    <td style="text-align: center"><?php echo ucfirst($key->waktu)  ?></td>
                                    <td style="text-align: center">
                                        <a href="<?php echo base_url('penilaian_keaktifan/update/'.$key->id_penilaian_keaktifan.'/'.$id_camaba)?>">
                                            <span class="text-primary" style="font-size:21px">
                                                    <i class="fas fa-pencil-alt"></i>
                                            </span>
                                        </a> | 
                                        <a href="<?php echo base_url('penilaian_keaktifan/delete/'.$key->id_penilaian_keaktifan.'/'.$key->id_camaba)?>">
                                            <span class="text-primary" style="font-size:21px">
