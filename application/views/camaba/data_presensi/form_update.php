...
<div class="row">
        ...
        <div class="col-md-9">
            ...
            <form action="<?php echo base_url($action).'/'.$dataPresensi->id_presensi.'/'.$id_camaba?>" method="post" class="offset-md-1">
                <div class="form-group row ">
                <label class="col-md-4 ">Waktu</label>
                    <div class="col-md-7">
                        <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                            <input type="text" name="datetime" class="form-control datetimepicker-input" value="<?php echo date("m/d/Y h:i A", strtotime($dataPresensi->waktu_presensi)) ?>" data-target="#datetimepicker1"/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="number" name="poin" id="no_hp" class="form-control" value=<?php echo $dataPresensi->keterangan   ?> >
                    </div>
                </div>
                    <button type="cancel" class="btn btn-default ">
                        <a href="<?php echo base_url("data_presensi/detail_presensiMaba/".$id_camaba)?>">Cancel</a>
                    </button>
