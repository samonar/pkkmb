...
<a href="<?php echo base_url('data_camaba/create/'.$id) ?>">
...
<table class="table table-bordered table-striped" id="example1">
        ...
        foreach ($list_camaba as $key) {
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <a href="<?php echo base_url('data_camaba/detailCamaba/'.$key->nim)?>">
                        <span class="text-primary" style="font-size:21px">
                                <i class="fa fa-eye"></i>
                        </span>
                    </a> | 
                    <a href="<?php echo base_url('data_camaba/delete/'.$key->nim.'/'.$key->id_prodi)?>" onclick="return checkDelete()">
                    <span class="text-primary" style="font-size:21px">
